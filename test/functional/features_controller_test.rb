...
class FeaturesControllerTest < ActionController::TestCase
  ...
  test "should create feature" do
    assert_difference('Feature.count') do
      post :create, feature: { feature_name: @feature.feature_name, franchise_set_id: @feature.franchise_set_id }
    end
  ...
  test "should update feature" do
    put :update, id: @feature, feature: { feature_name: @feature.feature_name, franchise_set_id: @feature.franchise_set_id }
    assert_redirected_to feature_path(assigns(:feature))
  end
